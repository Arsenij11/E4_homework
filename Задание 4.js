...
function Equipment(name, color, weight, power, owncharacteristics) {
    this.name = name;
    this.color = color;
    this.weight = weight;
    this.power = power;
...
Object.setPrototypeOf(power_unit, EquipmentPrototype);
Object.setPrototypeOf(lamp, EquipmentPrototype);
